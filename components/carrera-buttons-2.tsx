...
import CaballoButton from './CaballoButton'
...
const CarreraButton2 = ({ carrera, selected =0,num_caballos,onSeleccion}: Props) => {
    ...
    <View style={styles.col}>
      ...
      <ScrollView style={styles.container} horizontal showsHorizontalScrollIndicator={false}>
        {Caballos.slice(0,num_caballos).map((caballo, index) => (
          <CaballoButton key={index} label={String(caballo)} onPress={() =>onSeleccion(carrera, caballo)} 
